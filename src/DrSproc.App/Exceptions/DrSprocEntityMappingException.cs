...
namespace DrSproc.Exceptions
{
    ...
    {
        private DrSprocEntityMappingException(InProcessStoredProc sproc, string message)
            : base($"The following error occurred while Dr Sproc attempted to read from the database {null} and sproc '{null}': " + message)
        {
        }

        internal static DrSprocEntityMappingException FieldDoesntExist(InProcessStoredProc sproc, string fieldName)
        {
        ...
        internal static DrSprocEntityMappingException FieldOfWrongDataType(InProcessStoredProc sproc, string fieldName, Type typeRequested, Type actualType, object actualValue)
        {
        ...
        internal static DrSprocEntityMappingException RequiredFieldIsNull(InProcessStoredProc sproc, string fieldName)
        {
