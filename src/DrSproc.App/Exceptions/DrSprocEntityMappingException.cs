...
namespace DrSproc.Exceptions
{
    public class DrSprocEntityMappingException : Exception
    {
        ...
        internal static DrSprocEntityMappingException FieldDoesntExist(StoredProc sproc, string fieldName)
        {
        ...
        internal static DrSprocEntityMappingException FieldOfWrongDataType(StoredProc sproc, string fieldName, Type typeRequested, Type actualType, object actualValue)
        {
        ...
        internal static DrSprocEntityMappingException RequiredFieldIsNull(StoredProc sproc, string fieldName)
        {
